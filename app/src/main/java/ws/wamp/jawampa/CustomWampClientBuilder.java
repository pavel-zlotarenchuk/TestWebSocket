 ...
 */
public class CustomWampClientBuilder {
     ...
     */
    public CustomWampClientBuilder() {
     ...
     */
    public CustomWampClient build() throws Exception {
        if (uri == null)
        ...
        return new CustomWampClient(clientConfig);
    }
     ...
     */
    public CustomWampClientBuilder withUri(String uri) {
        this.uri = uri;
        return this;
    }
     ...
     * @return The {@link WampClientBuilder} object
     */
    public CustomWampClientBuilder withRealm(String realm) {
        this.realm = realm;
        return this;
    }
     ...
     * @return The {@link WampClientBuilder} object
     */
    public CustomWampClientBuilder withRoles(WampRoles[] roles) {
        this.roles.clear();
    ...
    public CustomWampClientBuilder withConnectorProvider(IWampConnectorProvider provider) {
        this.connectorProvider = provider;
        return this;
    }

    public CustomWampClientBuilder withConnectionConfiguration(IWampClientConnectionConfig configuration) {
     ...
     * @return The {@link WampClientBuilder} object
     */
    public CustomWampClientBuilder withSerializations(WampSerialization[] serializations) throws ApplicationError {
     ...
     * @return The {@link WampClientBuilder} object
     */
    public CustomWampClientBuilder withStrictUriValidation(boolean useStrictUriValidation) {
     ...
     * @return The {@link WampClientBuilder} object
     */
    public CustomWampClientBuilder withCloseOnErrors(boolean closeOnErrors) {
     ...
     */
    public CustomWampClientBuilder withNrReconnects(int nrReconnects) throws ApplicationError {
        if (nrReconnects < 0)
     ...
     * @return The {@link WampClientBuilder} object
     */
    public CustomWampClientBuilder withInfiniteReconnects() {
        this.nrReconnects = -1;
        return this;
    }
     ...
     */
    public CustomWampClientBuilder withReconnectInterval(int interval, TimeUnit unit) throws ApplicationError {
     ...
     * @return The {@link WampClientBuilder} object
     */
    public CustomWampClientBuilder withAuthId(String authId) {
        this.authId = authId;
        return this;
    }
     ...
     * @return The {@link WampClientBuilder} object
     */
    public CustomWampClientBuilder withAuthMethod(ClientSideAuthentication authMethod) {
